...
// ★ 上書きがどの区画を食うかも §3-2 は書いていない。**平野を最後に食う**（森林→山→荒地→平野）。
//   上書きは川r枚＋海湖2枚＋鉱脈4枚で最大9枚に達しうる。先頭から食うと
//   丘（平野8・森林4・山4）で平野が 8→2枚 まで落ち、§2-2 の致死ライン（3枚）を割る。
const EAT = [R.WOOD, R.MTN, R.WASTE, R.PLAIN, R.RIVER, R.WATER];
